...
export function BubbleIntro({ eyebrow, title, lede, className }: BubbleIntroProps) {
  return (
    <header className={clsx("grid max-w-[22rem] gap-3 text-center lg:text-left", className)}>
      ...
      <h1 className="text-balance text-[clamp(2.25rem,12vw,3.5rem)] font-medium leading-[0.9] tracking-[-0.04em] text-white sm:text-[clamp(3.2rem,5.2vw,4.7rem)] sm:leading-[0.88]">
        {title}
      </h1>
