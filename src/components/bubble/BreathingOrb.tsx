  ...
  return (
    <div className="flex w-full justify-center">
      ...
      >
        ...
        <div className="absolute inset-7 flex items-center justify-center rounded-full bg-[radial-gradient(circle_at_center,rgba(0,153,255,0.22),transparent_58%),rgba(6,12,17,0.82)] p-6 text-center shadow-[0_0_0_1px_rgba(0,153,255,0.15),0_10px_30px_rgba(0,0,0,0.25),0_0.5px_0_0.5px_rgba(255,255,255,0.1)] sm:inset-6 sm:p-8">
          <div className="grid gap-2">
            <p className="text-[0.78rem] font-medium uppercase tracking-[0.14em] text-sky-400">
              Now
            </p>
            <p className="m-0 text-[clamp(1.25rem,8vw,2.1rem)] font-medium leading-[0.96] tracking-[-0.06em] text-white">
